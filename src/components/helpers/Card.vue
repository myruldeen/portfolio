    ...
    >
      ...
      <div class="card-body pborder-top">
        ...
        <div>
          ...
          <p
            class="title3 m-0 pb-2 pheight pt-1 pb-2"
            v-html="
        ...
        <div class="text-center">
          <button
            href=""
            class="btn-sm btn btn-outline-secondary no-outline rounded-pill"
          ...
          <button
            href="#"
            class="btn-sm btn btn-outline-secondary no-outline ml-4 rounded-pill"
